...
import waitingGameHandler from './game/waitingGame.handler.js';
...
const handlers = {
  ...
  [HANDLER_IDS.GET_GAMELIST]: {
    ...
    protoType: 'game.GetGameListRequest',
  },
  ...
  [HANDLER_IDS.WAITING_GAME]: {
    handler: waitingGameHandler,
    protoType: 'game.WaitingGameRequest',
  },
